 ...
 */
 ...
 $stringPanel_2 =    $data['stringPanel_2'];  // A string intended of the Left Hand Side of the page
 $stringPanel_3 =    $data['stringPanel_3']; // A string intended of the Right Hand Side of the page
 $panelHead_1=$data['panelHead_1'];// A string containing the LHS panel heading/title
 $panelHead_2=$data['panelHead_2'];// A string containing the MIDDLE panel heading/title
 $panelHead_3=$data['panelHead_3'];// A string containing the RHS panel heading/title
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="row">
    <!--Left Hand Side (LHS) content panel - PANEL 1--> 
    ...
    <!--Middle section (MID)  content panel - PANEL 2 --> 
    ...
    <!--Right Hand Side (RHS) content panel - PANEL 3 --> 
    <div class="col-md-3" style="background-color:white;">
            <div class="panel panel-default">
              <div class="panel-heading"><?php echo $panelHead_3; ?></div>
              <div class="panel-body">
                    <?php echo $stringPanel_3; ?>
              </div>
            </div>
    </div>
</div>
